...
PlaneStressStrain::PlaneStressStrain(QuadrilateralMesh2D *mesh,
                                     ...
                                     ValueFunction volumeForce) : Fem(mesh)
{
...
double PlaneStressStrain::isoTriangle3(const double &xi, const double &eta, double x[], double y[], DoubleVector &N, DoubleVector &dNdX, DoubleVector &dNdY)
{
