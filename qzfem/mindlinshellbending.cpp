...
MindlinShellBending::MindlinShellBending(Mesh3D *mesh, double thickness, const std::vector<double> &strain, const std::vector<double> &stress, double nu, std::list<FemCondition *> conditions) :
    Fem2D(mesh, 6)
{
    const double kappa = 5.0 / 6.0;
...
DoubleVector MindlinShellBending::evalForces(Mesh3D *mesh, std::list<FemCondition *> conditions)
{
    DoubleVector force(dimension_, 0.0); // вектор сил
